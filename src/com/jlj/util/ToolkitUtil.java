...
public class ToolkitUtil {
     ...
     * 生成6位随机数
     */
    public static String getRandomNum(int total){
    	Random random=new Random();
		int rand=random.nextInt((int) Math.pow(10, total));
    ...
    public static void main(String[] args) {  
        ...
        /*String pwd1="1234";  
        String pwd2="";  
        ToolkitUtil cipher = new ToolkitUtil();  
    	...
    	//产生随机数6位
    	System.out.println(ToolkitUtil.getRandomNum(6));
    	//timestamp测试
    	Timestamp ts = new Timestamp(System.currentTimeMillis()); 
    	System.out.println(System.currentTimeMillis()/1000);
    	//二次加密测试
    	String pwd1="1paper2013";  
        String pwd2="";  
        ToolkitUtil cipher = new ToolkitUtil();  
        System.out.println("未加密的密码:"+pwd1);  
        //将1paper二次加密  
