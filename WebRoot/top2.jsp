...
<div class="top_all">
 ...
 <div class="top_rig">
   <div class="top_tz_wel"><span style="padding-right:10px;line-height:26px; color:#FFF; font-size:14px">您好,欢迎使用能源物联网管理系统管理系统!
          [<a href="main.jsp" target="rightFrame">平台主页</a>]
   ...
   <div class="top_tz">
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr>
         ...
         <td width="83%">${user.username},欢迎您进入能源物联网管理系统!</td>
       </tr>
     </table>
   </div>
 </div>
