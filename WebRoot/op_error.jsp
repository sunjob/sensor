...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><div style='float:left'> <img height="14" src="skin/images/frame/book1.gif" width="20" />&nbsp;能源物联网管理系统 </div>
...
<table width="98%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px;margin-top:8px;">
  ...
  <tr bgcolor="#FFFFFF">
    <td>${errorInfo }&nbsp;&nbsp; <a href="javascript:history.back();" target="rightFrame">返回</a></td>
  </tr>
</table>
