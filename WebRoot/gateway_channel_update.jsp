...
<div class="linedwon"><img src="skin/images/frame/jiantou.gif" width="20" height="20" border="0">当前位置：系统管理&gt;&gt;配置无线数据通道&nbsp;<a href="javascript:history.go(-1);location.reload();" style=" color:red;">[返回]</a></div>
<!--  内容列表   -->
