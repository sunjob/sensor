...
<div class="linedwon"><img src="skin/images/frame/jiantou.gif" width="20" height="20" border="0">当前位置：系统设置&gt;&gt;网关街景图片&nbsp;<a href="javascript:history.back();" style=" color:red;">[返回]</a></div>
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="30" >
	...
	<td width="75%" align="left">
	  <label>
				<img alt="暂无图片" src="<%=basePath%>streetpic${gateway.streetpic}" id="myimage" width="300px" height="256px"height="auto"/>
	  </label></td>
</tr>
</table>
