		...
		$.ajax({   
	            ...
	            { //成功
	            	...
	            	for(var i=0;i<linetowers.length;i++)
	            	{
	            		...
	            		console.log(towerid);
	            	$("#linetower").val(towerid);
	            	console.log($("#linetower").val());
		        }
    	    });  
	...
	<body leftmargin="8" topmargin="8" onload="getTower()">
		<div class="linedwon">
			<img src="skin/images/frame/jiantou.gif" width="20" height="20"
				border="0">
			当前位置：系统管理&gt;&gt;
			<a href='javascript:history.back();' target='main'>测温点管理</a>&gt;&gt;修改测温点&nbsp;
			<a href="javascript:history.back();" style="color: red;">[返回]</a>
		</div>

		<!--  内容列表   -->
		<form name="form2" action="temppointAction!update" method="post" onclick="return checkNum2()">
			...
			<table width="50%" border="0" cellpadding="2" cellspacing="1"
				...
				<tr bgcolor="#E7E7E7">
					<td height="33" colspan="2" align="center">
						...
						<s:hidden name="temppoint.id" />
						<s:hidden name="temppoint.lasttp" />
						<s:hidden name="temppoint.lastv" />
						<s:hidden name="page"/>
					</td>
				</tr>
				...
				<tr align="center" bgcolor="#FFFFFF"
					...
					<td width="75%" align="left">
						<label>
							<select name="linetower" id="linetower" onclick="changeTower()">
							</select>
						</label>
					</td>
				</tr>
				...
				<tr align="center" bgcolor="#FFFFFF"
					...
					<td width="75%" align="left">
						<label>
							<s:select list="#{1:'A1相',2:'A2相',3:'B1相',4:'B2相',5:'C1相',6:'C2相',0:'未知相位'}"
								name="temppoint.phasetype" listKey="key" listValue="value"></s:select>
						</label>
					</td>
				</tr>
				...
				<tr align="center" bgcolor="#FFFFFF"
					...
					onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25">
					<td width="25%" height="25" align="right">
						<strong><font color="#333333">排序编号</font> </strong>
					</td>
					<td width="75%" align="left">
						<label>
							<s:textfield id="orderid" name="temppoint.orderid" cssStyle="width:80%"
								></s:textfield>
						</label>
					</td>
				</tr>
