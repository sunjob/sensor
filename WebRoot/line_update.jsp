...
<div class="linedwon"><img src="skin/images/frame/jiantou.gif" width="20" height="20" border="0">当前位置：系统管理&gt;&gt;<a href='javascript:history.back();' target='main'>线路管理</a>&gt;&gt;修改线路&nbsp;<a href="javascript:history.back();" style=" color:red;">[返回]</a></div>
  
<!--  内容列表   -->
<form name="form2" action="lineAction!update" method="post"  enctype="multipart/form-data" onsubmit="return checkform();" >

<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#E7E7E7">
	<td height="33" colspan="2" align="center"><strong>修改线路</strong>
  
    <s:hidden name="line.id"/>
    <s:hidden name="line.orderid"/>
      <!--
    <s:hidden name="bigtype.image" />
...
<tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="25" >
	...
	<td width="75%" align="left">
	  <label>
		...
		<s:textfield name="line.orderid" id="orderid" cssClass="ck"  cssStyle="width:80%"></s:textfield>
