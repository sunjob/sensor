					...
					<tr>
					 ...
					 <tr>
					 	<td style="text-align: center;">
							...
							<a href="#" onClick="javascript:jumpReportPage('sensordataAction!reportdetailformobile',document.getElementById('page').value,'<s:property value="starttime"/>','<s:property value="endtime"/>',<s:property value="con"/>,'<s:property value="convalue"/>',<s:property value="stype"/>,<s:property value="limits"/>,<s:property value="projectid"/>,'<s:property value="linetext"/>',<s:property value="upuserid"/>);"><img src="img/go1.png" width="35" height="30" style="vertical-align: middle;"/></a>
							&nbsp;
